...
export class VuzService {
  ...
  private vuzList: Vuz[] = [
    ...
    {vuzname: 'РТУ МИРЭА Прикладная математика', subj: 'Информатика', point:263},
    {vuzname: 'РТУ МИРЭА Информатика и вычислительная техника', subj: 'Информатика', point:255},
    {vuzname: 'РТУ МИРЭА Прикладная информатика', subj: 'Информатика', point:243},
    {vuzname: 'РТУ МИРЭА Программная инженерия', subj: 'Информатика',point:273},
  ];
